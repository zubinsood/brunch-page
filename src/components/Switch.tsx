...
function SunIconActive() {
    return (
        <svg className="sun-icon" xmlns="http://www.w3.org/2000/svg" x="48.5" y="10" width="16" height="16" viewBox="0 0 16 16" fill="none">
...
function MoonIconActive() {
    return (
        <svg className="moon-icon" xmlns="http://www.w3.org/2000/svg" x="14" y="10" width="15" height="15" viewBox="0 0 15 15" fill="none">
